...
from trainer import trainer_synapse, trainer_zebrafish
from config import get_config

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/projects/wan-lab/zebrafish/annotations_harshil', help='root dir for data')
parser.add_argument('--dataset', type=str,
                    default='Zebrafish', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='/projects/wan-lab/zebrafish/swin_unet_2d_implementation/Swin-Unet/lists/lists_Synapse', help='list dir')
...
if __name__ == "__main__":
    ...
    trainer_zebrafish(args, net, args.output_dir)
